...
The Dataset is take from: https://www.kaggle.com/datasets/jannesklaas/scifi-stories-text-corpus

For training, testing, and validation we have taken 2% of dataset only and this data set is also used for fine-tuning llm's and transformer's 